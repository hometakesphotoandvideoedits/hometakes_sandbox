            ...
            <form class="form-edit" enctype="multipart/form-data" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="fname" type="text" class="form-control" name="fname" value="{{$users->fname}}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="lname">Lastname:<span class="req-field"> *</span></label>
                        <input id="lname" type="text" class="form-control" name="lname" value="{{$users->lname}}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="credentials">Credentials:<span class="req-field"> *</span></label>
                        <input id="credentials" type="text" class="form-control" name="credentials" value="{{$users->credentials}}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="mls_id">MLS Agent ID:<span class="req-field"> *</span></label>
                        <input id="mls_id" type="text" class="form-control" name="mls_id" value="{{$users->mls_agent_id}}" required>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="cp_no" type="text" class="form-control" name="cp_no" value="{{$users->phone}}" required>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="asst_cp" type="text" class="form-control" name="asst_cp" value="{{$users->assist_phone}}">
                    </div>
                    <div class="col-md-6">
                        <label for="web_name">Website Name:<span class="req-field"> *</span></label>
                        <input id="web_name" type="text" class="form-control" name="web_name" value="{{$users->website}}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="brok_comp">Brokerage Company:<span class="req-field"> *</span></label>
                        <input id="brok_comp" type="text" class="form-control" name="brok_comp" value="{{$users->company}}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="bill_add">Billing Address:<span class="req-field"> *</span></label>
                        <input id="bill_add" type="text" class="form-control" name="bill_add" value="" required>
                    </div> 
                    <div class="col-md-6">
                        <label for="city">City:<span class="req-field"> *</span></label>
                        <input id="city" type="text" class="form-control" name="city" value="{{$users->city}}" required>
                    </div> 
                    <div class="col-md-6">
                        <label for="zipc">Zipcode:<span class="req-field"> *</span></label>
                        <input id="zipc" type="text" class="form-control" name="zipc" value="{{$users->zip}}" required>
                    </div> 
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" class="form-control" id="comp_logo" name="comp_logo" value="{{$users->logo}}">
                    </div> 
                    <div class="col-md-6">
                ...
                <hr>
                <button class="btn btn-primary pull-right mar1" type="button" id="btn-update"><i class="fa fa-user-plus"></i> Update Profile</button>
            </form>
        </div>
    </div>
</div>
